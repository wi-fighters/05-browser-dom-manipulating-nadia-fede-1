(() => {
  ...
  sortedBooks.forEach(book => {
      ...
      li.classList.add("col-lg-2", "col-md-4", "col-sm-6", "m-2", "p-0");
  
      ul.appendChild(li);

      // create img element and set the attribute

      const img = document.createElement("img");
      img.setAttribute("src", book.img);
      img.classList.add("img-height", "img", "w-100") 
      li.appendChild(img);

      // created h2 and append the title
      ...
      // create h3 and append the name and last name of the author using the sorted array in the global scope
      ...
      if (book.alreadyRead) {
        ...
        // span.appendChild(readOrNotRead);
